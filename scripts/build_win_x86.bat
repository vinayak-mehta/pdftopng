...
Rem set PATH=%PATH%;c:\vcpkg\installed\x86-windows\bin
...
Rem cmake -A Win32 -DCMAKE_TOOLCHAIN_FILE=c:/vcpkg/scripts/buildsystems/vcpkg.cmake -DENABLE_QT5=OFF -DENABLE_LIBOPENJPEG=none -DENABLE_CPP=OFF -DENABLE_BOOST=OFF ..
